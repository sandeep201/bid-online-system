    ...
    <form action="add.php" method="post">
        ...
        <?php include("dbconnect.php");
			...
			{ 
				...
				(id,bookname,createdate,createuser,author,type,
				updateday,price,picturebook,description) values 
				('$id','$bookname', '$createdate', '$createuser','$author',
				 '$type','$updateday','$price','$picturebook','$description')"; 
